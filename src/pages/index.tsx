    ...
    <main className="bg-white flex flex-col justify-center items-center max-w-[1200px] border border-zinc-500 mx-auto">
      ...
      <div className="flex flex-col gap-9 bg-zinc-900 pb-10 sm:pb-4 md:h-[600px]">
        ...
        <strong className="uppercase text-center text-lg sm:text-3xl md:text-4xl text-zinc-200 px-4">
          We are a collective of IRL models & 3D artists. 
          We support eachother & collectively resist IBS.
        </strong>

        {/* <span className=" font-semibold text-center text-lg sm:text-2xl -mt-4 text-zinc-300">Impossible Beauty Standaros</span> */}

        <span className="text-justify text-zinc-400 text-base sm:text-2xl md:text-3xl px-6">Demand always fluctuates, but when you ARE the commodity, adjusting yourself to trends isn't sustainable.  Our difference makes us valuable & together with some of the most talented 3D artists on the internet and blockchain technology we can make sure the future of fashion stays relevant for humans that value a world where humans thrive and don't oppress each-other with outdated narratives.</span>
